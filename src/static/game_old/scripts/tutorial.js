instructions_tut1 = ["Welcome to Think Again! We will now guide you step by step through the process of playing this game! <br> Click 'Next' to continue", 
				...
				"Notice after clicking Piece 0, Piece 2 fades a little. This means no result was produced by combining 0 and 2.<br> Now make sure you have clicked Piece 0 and then click on Piece 1",
...
instructions_tut2 = ["Now we can solve a much bigger problem! <br> But before you do that, we need to explain a few things ",
					...
					"<br> After solving this puzzle please solve the next level called '3-Beginner' at least 3 times. You can continue playing the 4th and 5th levels if you like (No one has solved the 5th level yet)" +
